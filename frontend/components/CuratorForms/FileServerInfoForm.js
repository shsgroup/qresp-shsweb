...
const FileServerInfoForm = ({ editor }) => {
  ...
  return (
    <Drawer heading="Where is the data" defaultOpen={true}>
          ...
          <Grid item>
            {watchConnectionType == "http" ? (
              <SelectInputField
                ...
                helperText="Select URL of remote server where paper content is organized and located. e.g. https://shsarchive.chem.yale.edu/papers/"
                label="File Server"
                options={httpServers}
                required={true}
                name="dataServer"
              ...
              <TextInputField
                ...
                name="dataServer"
                helperText="e.g. https://zenodo.org/record/3981451"
                label="Zenodo"
                required={true}
                error={errors.dataServer}
                inputRef={register}
